...
treasury_data <- 
  read.xlsx("C:\\Users\\1217543\\OneDrive\\Market Data\\Market-Dashboard\\Rate File\\MRKTRATE - 12.27.2018.xlsx", 
          sheetName = "Treasury Rates",
          startRow = 3,
          colIndex = 1:8)
...
colnames(t_spreads) <- c("2 vs 5", "5 vs 10", "10 vs 20", "20 vs 30")
  ...
  t_spread_last <- xts::last(t_spreads) # Pulls the last row in the treasury spreads data set.
    ...
    t_spread_ytd_delta <-  
      rbind(t_spread_ye, t_spread_last) # Combines them into a single data frame (for simple differencing)
  ...
  # Alternative Yahoo Finance Compilations
    USDCAD = getSymbols("CAD=X", src = "yahoo", auto.assign = FALSE)
      USDCAD = USDCAD[ ,4 ]
        ...
        FXEnd = Sys.Date() - 2
        USDCAD = USDCAD["2017-10-11/2018-12-29"]
...
#YTD Change
Moodys_YE = Moodys_InvGrade_Spread['2019-01-02/'] 
...
```{r, echo=FALSE}
  ...
  Repwest.Exposure.YE18 = Repwest.Exposure['2019-01-02']
