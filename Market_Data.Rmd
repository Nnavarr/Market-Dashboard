...
|:-------:|:-------:|:------:|:-----:|:----:|
|W/W (BPS)| -18.76    |-47.50  |-55.45 |-22.78|
|YTD (BPS)|+1.24    |-16.50  |-16.45 |-13.78|
|Current  | 0.24    | 0.50   |0.55   |0.22|
***
...
datatable(FEDfund.meetingProb, colnames = c("Meeting Date", "0-25", "25-50"), options = list(bPaginate = FALSE))
```
